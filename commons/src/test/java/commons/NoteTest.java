...
public class NoteTest {
    ...
    private static final Note note = new Note("TestNote", "This is a Test", 0, "");
    ...
    public void equalsHashCodeTest() {
        Note note1 = new Note("TestNote", "This is a Test", 0, "");
        Note note2 = new Note("TestNote", "This is another Test", 0, "");
    ...
    public void ToStringTest() {
        ...
        var NoteTest = new Note("ToStringTest", "This is the content", 0, "").toString();
    ...
    public void noteTitleNotEmpty(){
        Note note = new Note("   ", "This is a Test", 0, "");
        Note note2 = new Note("", "This is a Test", 0, "");
        Note note3 = new Note("title", "This is another Test", 0, "");
